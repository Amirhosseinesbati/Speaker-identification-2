...
def main() -> int:
    ...
    parser.add_argument("--archive-prefix", help="Require exactly this single root directory inside the ZIP")
    parser.add_argument("--expected-labels-sha256", help="Also verify byte-exact original labels.csv SHA256")
    parser.add_argument("--archive-source-id", default="local_upload", help="Recorded transport identity, e.g. official_original")
