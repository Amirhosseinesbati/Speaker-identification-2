...
if [ "$#" -ne 1 ]; then
    printf '%s\n' 'Usage: install_experiment_supervisor.sh <S001|S002|S003|S004|S005|S006|S007|S008|S009|S010|P001|P002|B002|F001|F002|F003|F004>' >&2
    exit 2
fi
case "$1" in
    S010)
        PROGRAM=speaker_id_campp_s010
        SOURCE=configs/infra/supervisor_campp_gain.conf
        ;;
    S009)
    ...
    S004)
        ...
        ;;
    P002)
        PROGRAM=speaker_id_campp_p002
        SOURCE=configs/infra/supervisor_campp_package_selected.conf
        ;;
    P001)
