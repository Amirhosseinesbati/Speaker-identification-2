"""Run the portable speaker identification submission with local assets only."""
...
def main(argv=None):
    ...
    from speaker_id.inference.runtime import run_submission
